						...
						<div class="row mb-2">
							...
							<div class="col-sm-8">
								<div class="text-sm-end">
									...
									<b-modal v-model="showModal" title="Add New Customer"
										...
										<form @submit.prevent="handleSubmit">
											<div class="row">
												<div class="col-12">
													<div class="mb-3">
														...
														<input id="name" v-model="customers.username" type="text"
															class="form-control" placeholder="Insert username" :class="{
																'is-invalid':
																	submitted && v$.customers.username.$error,
															}" />

														<div v-if="submitted && v$.customers.username.$error"
												...
												<div class="col-12">
													<div class="mb-3">
														...
														<input id="phone" v-model="customers.phone" type="text"
															class="form-control" placeholder="Insert phone" :class="{
																'is-invalid':
																	submitted && v$.customers.phone.$error,
															}" />
														<div v-if="submitted && v$.customers.phone.$error"
															class="invalid-feedback">
												...
												<div class="col-12">
													<div class="mb-3">
														...
														<input id="email" v-model="customers.email" type="email"
															class="form-control" placeholder="Insert email" :class="{
																'is-invalid':
																	submitted && v$.customers.email.$error,
															}" />
														<div v-if="submitted && v$.customers.email.$error"
															class="invalid-feedback">
												...
												<div class="col-12">
													<div class="mb-3">
														...
														<input id="address" v-model="customers.address" type="text"
															class="form-control" placeholder="Insert address" :class="{
																'is-invalid':
												...
												<div class="col-12">
													<div class="mb-3">
														...
														<input id="balance" v-model="customers.balance" type="text"
															class="form-control" placeholder="Insert balance" :class="{
																'is-invalid':
																	submitted && v$.customers.balance.$error,
															}" />
														<div v-if="submitted && v$.customers.balance.$error"
															class="invalid-feedback">
											...
											<div class="text-end pt-5 mt-3">
												...
												<b-button type="submit" variant="success" class="ms-1">Create event
												</b-button>
											</div>
										</form>
									</b-modal>
									...
									<tr v-for="customers in customersData" :key="customers.id">
										<td>
											<div class="form-check font-size-16">
												<input :id="`customCheck${customers.id}`" type="checkbox"
													class="form-check-input" />
												<label class="form-check-label"
													:for="`customCheck${customers.id}`">&nbsp;</label>
											</div>
										</td>
